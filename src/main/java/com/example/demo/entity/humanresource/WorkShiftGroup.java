...
@Entity
@Table(name = "work_shift_group")
@Data
@SQLDelete(sql = "UPDATE work_shift_group SET is_deleted = true WHERE work_shift_group_id = ?")
...
public class WorkShiftGroup {
    ...
    @Column(name = "work_shift_group_code", length = 50, unique = true)
