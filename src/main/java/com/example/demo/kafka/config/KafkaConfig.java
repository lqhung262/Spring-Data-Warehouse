...
public class KafkaConfig {
    ...
    public NewTopic dlqTopic() {
        return TopicBuilder.name("human-resource.dlq.v1")
                .partitions(3)
                .replicas(1)
                .build();
    }
    ...
    // ==================== DLQ CONSUMER CONFIGURATION (with retry) ====================
    ...
    public ConcurrentKafkaListenerContainerFactory<String, Object> dlqKafkaListenerContainerFactory() {
        ...
        // Configure retry mechanism: 3 retries with 5 seconds interval
        DefaultErrorHandler errorHandler = new DefaultErrorHandler(
                new FixedBackOff(5000L, 3) // 5 seconds interval, 3 retries
        );
